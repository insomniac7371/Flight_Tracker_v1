...
// Tomorrow.io free tier is 25 req/hr, 500/day. Each refresh = 1 call; these
// intervals keep us at ~5 calls/hr (~120/day) with headroom for restarts/pans.
const CURRENT_WEATHER_DATA_UPDATE_INTERVAL = 15 * 60 * 1000; //every 15 minutes
